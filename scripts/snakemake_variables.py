...
# Directory in which to find reference VCFs (optionally different from DATA)
...
RFMIX_OUTPUT_SCRIPT = "scripts/collapse_ancestry.py" # Adapted from Alicia Martin's GitHub
KARYOGRAM_SCRIPT = "scripts/plot_karyogram.py" # Adapted from Alicia Martin's GitHub
GLOBAL_INF_SCRIPT = "scripts/lai_global.py" # Adapted from Alicia Martin's GitHub
COMB_FN_SCRIPT = "scripts/combine_ancestry_calls.py"
